...
import { SendMsgParamsType } from '@typesApiMapping/apps/chatTypes'

import { createAppAsyncThunk } from 'src/store/utils'

// ** Fetch User Profile
export const fetchUserProfile = createAppAsyncThunk('appChat/fetchUserProfile', async () => {
...
export const fetchChatsContacts = createAppAsyncThunk('appChat/fetchChatsContacts', async () => {
...
// ** Select Chat
export const selectChat = createAppAsyncThunk(
    'appChat/selectChat',
...
// ** Send Msg
export const sendMsg = createAppAsyncThunk('appChat/sendMsg', async (obj: SendMsgParamsType, { dispatch }) => {
