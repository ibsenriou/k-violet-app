        ...
        <Box display='grid' gap='16px'>
            ...
            <Box display='grid' gap='16px'>
                ...
                <FormGroup>
                    ...
                    >
                        <FormControlLabel
                            defaultChecked={collection.format == CollectionFormat.single}
                            control={<Radio />}
                            label='Única'
                        />
                        <FormControlLabel
                            defaultChecked={collection.format == CollectionFormat.recurrent}
                            control={<Radio />}
                            label='Recorrente'
                        />
                        <FormControlLabel
                            defaultChecked={collection.format == CollectionFormat.installments}
                            control={<Radio />}
                            label='Parcelado'
                        />
                    </RadioGroup>
