...
import { ExpenseFormat } from './enums'
                ...
                <Box display='grid' gap='16px'>
                    ...
                    <Box display='grid' gap='16px'>
                        ...
                        <FormGroup>
                            ...
                            >
                                <FormControlLabel
                                    checked={collection.format == ExpenseFormat.unique}
                                    control={<Radio />}
                                    label='Única'
                                    disabled
                                />
                                <FormControlLabel
                                    checked={collection.format == ExpenseFormat.recurrent}
                                    control={<Radio />}
                                    label='Recorrente'
                                    disabled
                                />
                                <FormControlLabel
                                    checked={collection.format == ExpenseFormat.installments}
                                    control={<Radio />}
                                    label='Parcelado'
                                    disabled
                                />
