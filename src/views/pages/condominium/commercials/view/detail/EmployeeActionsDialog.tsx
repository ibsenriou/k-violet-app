...
const actionTypeConfig = {
    add: {
        ...
        content: 'Insira um funcionário nesta Unidade Comercial.'
    },
    edit: {
        title: 'Editar Funcionário',
        content: 'Edite as informações de um funcionário dessa Unidade Comercial.'
    },
    delete: {
        title: 'Remover Funcionário',
        content: 'Remova o funcionário da Unidade Comercial.'
    },
    view: {
        title: 'Visualizar Funcionário',
        content: 'Visualize as informações de um funcionário dessa Unidade Comercial'
    },
    default: {
...
const EmployeeActionsDialog = ({
    ...
    const _onSubmit = async (data: typeof defaultValues): Promise<void> => {
        ...
        queryClient.invalidateQueries({
          queryKey: ['commercial.employees', commercialId]
        })
