...
const actionTypeConfig = {
    add: {
        ...
        content: 'Insira um proprietário nesta Unidade Comercial.'
    },
    edit: {
        title: 'Editar Proprietário',
        content: 'Edite as informações de um proprietário dessa Unidade Comercial.'
    },
    delete: {
        title: 'Remover Proprietário',
        content: 'Remova o proprietário da Unidade Comercial.'
    },
    view: {
        title: 'Visualizar Proprietário',
        content: 'Visualize as informações de um proprietário dessa Unidade Comercial'
    },
    default: {
...
const ProprietaryActionsDialog = ({
    ...
    const _onSubmit = async (data: ProprietaryData): Promise<void> => {
        ...
        const actionDispatchMap = {
            ...
            edit: () => {}, // not available in current business logic
            delete: () => wrapDispatch(deleteProprietary({id: commonPayload.id})),
            view: () => {} // do nothing
        }
        ...
        queryClient.invalidateQueries({
          queryKey: ['commercial.proprietaries', commercialId]
        })
