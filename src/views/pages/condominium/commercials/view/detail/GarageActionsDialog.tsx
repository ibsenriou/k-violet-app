...
import { addGarage, deleteGarage, updateGarage } from 'src/store/apps/condominium/commercialDetail'
...
const GarageActionsDialog = ({ actionType, actionData, open, toggle, commercialId }: GarageActionsDialogInterface) => {
    const {
        reset,
        control,
        handleSubmit,
    ...
    const actionTypeConfig = {
        add: {
            ...
            content: 'Insira uma garagem nesta Unidade Comercial neste condomínio.'
        },
        edit: {
            title: 'Editar Garagem',
            content: 'Edite as informações de uma garagem dessa Unidade Comercial.'
        },
        delete: {
            title: 'Remover Garagem',
            content: 'Remova a garagem da Unidade Comercial.'
        },
        view: {
            title: 'Visualizar Garagem',
            content: 'Visualize as informações de uma garagem dessa Unidade Comercial.'
        },
        default: {
    ...
    const _onSubmit = async (data: GarageType): Promise<void> => {
        ...
        queryClient.invalidateQueries({
          queryKey: ['commercial.garages', commercialId]
        })
