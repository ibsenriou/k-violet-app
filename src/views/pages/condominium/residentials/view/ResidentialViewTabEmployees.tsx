...
const ResidentialViewTabEmployees = () => {
    ...
    const employeesQuery = useQuery({
      queryKey: ['residential.employees', residential.id],
      queryFn: () =>
          CondominiumService.residentialId_employees
    ...
    return (
        <Card sx={{ marginBottom: 6 }}>
            <Table
                ...
                noRowsMessage='Este residencial não possui funcionários cadastrados.'
...
export default ResidentialViewTabEmployees
