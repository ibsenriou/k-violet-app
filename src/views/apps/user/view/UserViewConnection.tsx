        ...
        <Fragment>
            <Card sx={{ marginBottom: 6 }}>
                ...
                <CardContent>
                    ...
                    <Box
                        sx={{ display: 'flex', marginBottom: 7, alignItems: 'center', justifyContent: 'space-between' }}
                    >
                        <Box sx={{ display: 'flex', alignItems: 'center' }}>
            ...
            <Card>
                ...
                <CardContent>
                    ...
                    <Box
                        sx={{ display: 'flex', marginBottom: 6, alignItems: 'center', justifyContent: 'space-between' }}
                    >
                        <Box sx={{ display: 'flex', alignItems: 'center' }}>
